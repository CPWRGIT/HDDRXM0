      ...
      *                                                                *
      *  THIS PROGRAM IS A VSAM COBOL DEMO PROGRAM USED FOR            *
      *  TOPAZ FOR TOTAL TEST TRAINING SESSIONS.                       *
      *                                                                *
      *  INPUT FILE  - EMPLOYEE WAGE INFORMATION                       *
      *              - VSAM KSDS FILE PROCESSED SEQUENTIALLY           *
      *              - CREATED WITH ECC SLCXCNTL MEMBER - VSAMKSDS     *
      ...
      ******************************************************************
       ...
       FILE-CONTROL.
             SELECT EMPLOYEE-FILE ASSIGN EMPFILE
                    ORGANIZATION IS INDEXED
                    RECORD KEY IS EMP-REC-KEY
                    ACCESS MODE IS SEQUENTIAL.
*******             FILE STATUS IS W-INPUTFS W-INPUTVSAMCODE.
******************************************************
